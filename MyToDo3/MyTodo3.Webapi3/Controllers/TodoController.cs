...
namespace MyTodo3.Webapi3.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Add")]
        public async Task<ApiResponse> AddAsync(TodoDto todo) => await service.AddAsync(todo);
        ...
        [HttpPost]
        [Route("Update")]
        public async Task<ApiResponse> UpdateAsync(TodoDto todo ) => await service.UpdateAsync(todo);
    }
}
